...
import merge from '@browserql/fpql/merge'
...
/**
 * 
 * @param args Spread of property object, property object function constructor or GraphQL document node
 * @returns A BrowserQL client
 */
